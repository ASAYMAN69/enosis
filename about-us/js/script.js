...
document.addEventListener('DOMContentLoaded', function() {
    setActiveNavLink();
                ...
                const contactBtns = document.querySelectorAll('.card-overlay .contact-btn'); // Buttons to open modal
            
                console.log('Project Modal Element:', projectModal);
                console.log('Modal Close Button Element:', modalCloseBtn);
                console.log('Contact Buttons (NodeList):', contactBtns);
                console.log('Number of Contact Buttons:', contactBtns.length);
                ...
                if (projectModal && modalCloseBtn && contactBtns.length > 0) {
                    ...
                    contactBtns.forEach(btn => {
                        ...
                        btn.addEventListener('click', (event) => {
                            event.stopPropagation(); // Prevent card-overlay click from propagating
